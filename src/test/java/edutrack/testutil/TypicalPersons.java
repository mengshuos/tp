...
import static edutrack.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
import static edutrack.logic.commands.CommandTestUtil.VALID_ADDRESS_BOB;
import static edutrack.logic.commands.CommandTestUtil.VALID_EMAIL_AMY;
...
public class TypicalPersons {
    ...
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            ...
            .withTags("friends").withGroup("CS2103T", "CS2101").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").withGroup("CS2030S").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street").withGroup("CS2040S").build();
